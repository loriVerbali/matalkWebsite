          ...
          >
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <h1 className="h1 bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
                Matalk AI Playground
              </h1>
            </div>

            {/* Demo Selection Dropdown */}
            <div className="mb-8">
              <div className="inline-flex bg-white rounded-lg p-1 shadow-lg border border-violet-200">
                <button className="px-6 py-3 rounded-md font-semibold transition-all duration-300 bg-gradient-to-r from-violet-600 to-purple-600 text-white shadow-lg">
            ...
            <p className="lead text-slate-600 mb-8 max-w-2xl mx-auto">
              ...
              <span className="font-bold text-violet-600">Matalk AI</span>{" "}
                      ...
                      >
                        <div className="text-center mb-8">
                          ...
                          <p className="text-slate-600">
                            Reach out to Matalk AI to learn more
                          </p>
                        </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-slate-600 text-sm">
                            Quick response times for seamless communication
                            flow.
                          </p>
                        </div>
                      </div>
