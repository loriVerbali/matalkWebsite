          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-slate-700 mb-4">
                Welcome to Verbali, an AI-powered Augmentative and Alternative
                Communication (AAC) platform. By accessing or using Verbali's
                services, including our website, mobile applications, and
                related services (collectively, the "Service"), you agree to be
                bound by these Terms of Use ("Terms").
              </p>
              <p className="text-slate-700 mb-4">
                If you do not agree to these Terms, you may not access or use
                our Service. These Terms apply to all users, including
                individuals, parents, caregivers, healthcare professionals,
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                Verbali provides an AI-powered communication platform designed
                to support individuals with diverse communication needs. Our
                services include:
              </p>
            ...
            <section>
              ...
              <h3 className="h3 text-slate-900 mb-3">
                3.2 Minors and Supervised Accounts
              </h3>
              <p className="text-slate-700 mb-4">
                Accounts for users under 18 years of age must be created and
                supervised by a parent, legal guardian, or authorized caregiver
                who accepts responsibility for the minor's use of the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                You may use the Service for lawful communication and educational
                purposes, including:
              </p>
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  Research and academic purposes (with proper permissions)
                </li>
            ...
            <section>
              ...
              <h3 className="h3 text-slate-900 mb-3">
                5.1 Verbali's Intellectual Property
              </h3>
              <p className="text-slate-700 mb-4">
                The Service, including its AI algorithms, user interface,
                content, and technology, is protected by intellectual property
                laws. Verbali retains all rights to:
              </p>
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                <li>Matalk AI technology and algorithms</li>
              ...
              <p className="text-slate-700 mb-4">
                ...
                using Verbali, you grant us a limited license to:
              </p>
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                Your privacy is important to us. Our data collection, use, and
                protection practices are governed by our Privacy Policy, which
                is incorporated into these Terms by reference. Key privacy
                commitments include:
              </p>
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                Verbali offers various subscription plans with different
              ...
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  Automatic renewal unless cancelled according to our
                  cancellation policy
                </li>
                <li>
              ...
              <p className="text-slate-700 mb-4">
                Refund eligibility and cancellation procedures are detailed in
                our separate Billing and Refund Policy, available on our
                website.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                While Matalk AI is designed to assist communication, you
                acknowledge that:
              </p>
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                <li>
                  AI suggestions may not always be accurate or appropriate
                </li>
                <li>
                  The technology is continuously improving but not infallible
                </li>
                <li>
                  Human judgment should always be used in communication
                  decisions
                </li>
                <li>
              ...
              <h3 className="h3 text-slate-900 mb-3">
                8.2 Medical and Educational Disclaimer
              </h3>
              <p className="text-slate-700 mb-4">
              ...
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  Substitute for qualified educational or therapeutic services
                </li>
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                Verbali strives to provide consistent service availability, but
              ...
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  Update these Terms as necessary for legal or operational
                  reasons
                </li>
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                To the fullest extent permitted by law, Verbali and its
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                You agree to indemnify and hold harmless Verbali from any
              ...
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  Negligent or wrongful conduct related to your use of the
                  Service
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                ...
                contact our support team to resolve disputes informally.
              </p>
              ...
              <p className="text-slate-700 mb-4">
                ...
                American Arbitration Association, except where prohibited by
                law.
              </p>
            ...
            <section>
              ...
              <p className="text-slate-700 mb-4">
                ...
                users of material changes through:
              </p>
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-slate-700 mb-4 space-y-2">
                ...
                <li>
                  Verbali may suspend or terminate accounts for Terms violations
                </li>
                <li>
                  Upon termination, certain provisions (privacy, intellectual
                  property, indemnification) remain in effect
                </li>
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-slate-700 mb-2">
                  <strong>Email:</strong> legal@verbali.com
                </p>
                <p className="text-slate-700 mb-2">
                  <strong>Support:</strong> support@verbali.com
                </p>
                <p className="text-slate-700 mb-2">
                  <strong>Mail:</strong> Verbali Legal Department
                </p>
            ...
            <section className="bg-blue-50 rounded-lg p-6">
              ...
              <p className="text-slate-700">
                Verbali is committed to making our services accessible to all
                users. If you encounter accessibility barriers or need
                assistance with these Terms, please contact our accessibility
                team at accessibility@verbali.com. We will work to provide
                alternative formats and reasonable accommodations as needed.
              </p>
            </section>
          </div>
        </div>
