...
export default function PrivacyPolicyStandalone() {
  return (
                ...
                <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700">
                        <ul className="list-disc list-inside space-y-1">
                          <li>IP address, browser type, OS</li>
                          <li>Pages viewed, time spent, referring URL</li>
                        </ul>
                      </td>
                      <td className="px-6 py-4 text-sm text-gray-700">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    You may request to know, delete, correct, or limit use of
                    any Sensitive PI we hold (we collect none by default). We do
                    not sell or share personal information. We will not
                    discriminate if you exercise your rights.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    their information at any time. Withdrawing consent may limit
                    the services we can provide.
                  </p>
                </div>

                <p className="text-gray-700">
                  <strong>How to exercise rights:</strong> E-mail
                  info@verbali.io. We will verify your request and respond
